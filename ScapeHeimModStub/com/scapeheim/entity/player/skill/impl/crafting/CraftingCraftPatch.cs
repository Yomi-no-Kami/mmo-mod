...
namespace ScapeHeimModStub.com.scapeheim.entity.player.skill.impl.crafting
{
    ...
    public static class CraftingCraftPatch
    {
        /*
        ...
        )
        {
            ...
            if (!CraftingData.TryGet(item, out var data))
            {
                return true;
            }
            ...
            if (level < data.LevelReq)
            {
                MessageHud.instance.ShowMessage(
                    ...
                    $"Crafting level {data.LevelReq} required"
                );
        ...
        )
        {
            ...
            {
                string requirement =
                    $"<color=red>Crafting level {data.LevelReq} required!</color>\n\n";

                if (!__instance.m_recipeDecription.text.Contains("Crafting level"))
                {
